...
def validate_subscription() -> None:
    ...
    upstream = "py-cov-action/python-coverage-comment-action"
    ...
    body: dict[str, str] = {"action": action_repo}
    if server_url != "https://github.com":
        body["ghes_server"] = server_url

    github_repository = os.environ.get("GITHUB_REPOSITORY", "")
    api_url = (
        "https://agent.api.stepsecurity.io/v1/github/"
        f"{github_repository}/actions/maintained-actions-subscription"
    )
    ...
    try:
        ...
        if response.status_code == 403:
            print(
                "::error::\u001b[1;31mThis action requires a StepSecurity"
                " subscription for private repositories.\u001b[0m"
            )
            print(
                f"::error::\u001b[31mLearn how to enable a subscription:"
                f" {docs_url}\u001b[0m"
            )
            raise SystemExit(1)
    except SystemExit:
...
def post_comment(
    ...
    try:
        ...
        log.error(
            ...
            "issue at https://github.com/step-security/python-coverage-comment-action",
            exc_info=True,
        )
        return 1
...
def main(_action: Any = action):
    ...
    try:
        ...
        log.exception(
            ...
            "https://github.com/step-security/python-coverage-comment-action\n"
            "If you believe this is a bug in the action, please consult open issues or "
            "open a new one at https://github.com/step-security/python-coverage-comment-action/issues .\n"

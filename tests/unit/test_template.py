...
This report was generated by [python-coverage-comment-action](https://github.com/step-security/python-coverage-comment-action)
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            33,
            None,
            "https://github.com/step-security/python-coverage-comment-action/pull/33/files#diff-e52e4ddd58b7ef887ab03c04116e676f6280b824ab7469d5d3080e5cba4f2128",
        ),
        (
            ...
            33,
            None,
            "https://github.com/step-security/python-coverage-comment-action/pull/33/files#diff-b10564ab7d2c520cdd0243874879fb0a782862c3c902ab535faabe57d5a505e1R12-R15",
        ),
        (
            ...
            33,
            None,
            "https://github.com/step-security/python-coverage-comment-action/pull/33/files#diff-30cad827f61772ec66bb9ef8887058e6d8443a2afedb331d800feaa60228a26eR22-R22",
        ),
        (
            pathlib.Path("tests/conftest.py"),
            None,
            None,
            "mybranch",
            "https://github.com/step-security/python-coverage-comment-action/blob/mybranch/tests/conftest.py",
        ),
        (
            pathlib.Path("main.py"),
            (12, 15),
            None,
            "mybranch",
            "https://github.com/step-security/python-coverage-comment-action/blob/mybranch/main.py#L12-L15",
        ),
    ],
)
def test_get_file_url(filepath, lines, pr_number, branch_name, expected):
    result = template.get_file_url(
        ...
        lines=lines,
        github_host="https://github.com",
        repo_name="step-security/python-coverage-comment-action",
        pr_number=pr_number,
